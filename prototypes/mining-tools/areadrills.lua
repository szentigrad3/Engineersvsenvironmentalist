...
data:extend(
{
  ...
  },
  {
    ...
    results = {{type="item", name="area-mining-drill-2", amount=1}}
  },
  {
    type = "mining-drill",
    name = "area-mining-drill-2",
   ...
   input_fluid_box =
    ...
    {
      type = "electric",
      emissions_per_minute = { pollution = 0.01600002 },
...
{
  {
  ...
  },
   {
    ...
    results = {{type="item", name="area-mining-drill-3", amount=1}}
  },
  {
    type = "mining-drill",
    name = "area-mining-drill-3",
  ...
  data:extend(
{
  ...
  },
  {
    ...
    results = {{type="item", name="area-mining-drill-4", amount=1}}
  },
   {
    type = "mining-drill",
    name = "area-mining-drill-4",
   ...
   input_fluid_box =
    ...
    {
      type = "electric",
      emissions_per_minute = { pollution = 0.01588236 },
      usage_priority = "secondary-input"
    },
    energy_usage = "67.5MW",
    mining_speed = 16,
...
{
  {
    ...
    results = {{type="item", name="area-mining-drill-5", amount=1}}
  },
  {
    type = "mining-drill",
    name = "area-mining-drill-5",
   ...
   input_fluid_box =
    ...
    {
      type = "electric",
      emissions_per_minute = { pollution = 0.016039619999999997 },
      usage_priority = "secondary-input"
    },
    energy_usage = "101MW",
    mining_speed = 75,
